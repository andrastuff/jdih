...
var table 	= $('.dataTables-fetch').DataTable( {
        ...
        buttons: [
            ...
            language: {
            search: '<span>Cari Judul Artikel:</span> _INPUT_',
	...
	$('.dataTables-fetch tbody').on( 'click', '#edit', function () {
        var data = table.row( $(this).parents('tr') ).data();
         window.location.href = ServeUrl + 'artikel/edit_artikel/' + data['id']
	...
	$("#form-data").submit(function(event) {
        ...
        if($.isNumeric(id)){
            var path = ServeUrl+"artikel/api_update";
        }else{
            var path = ServeUrl+"artikel/api_save";
        }
