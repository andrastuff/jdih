...
class Urusanpemerintahan extends Backend_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('Urusanpemerintahan_Model');
    }
    ...
    public function index()
    {
        ...
        $data['content'] = 'urusanpemerintahan/html/index';
        $data['footer'] = array(
        ...
        $data['js_script'] = 'urusanpemerintahan/js/js';
	...
	public function api_list_all()
    {
		...
		$result 	= $this->Urusanpemerintahan_Model->get_all_where(null);
    ...
    public function api_list()
    {
		...
		$result 	= $this->Urusanpemerintahan_Model->get_all($limit, $offset, $search, $columns, $sort);
		$total		= $this->Urusanpemerintahan_Model->count_all($search);
    ...
    public function api_update()
	{
		...
		if ($this->Urusanpemerintahan_Model->update((int)$this->input->post('id', TRUE), $data)) { 	
    ...
    public function api_save()
	{
		...
		if ($this->Urusanpemerintahan_Model->save($data)) { 	
		$this->output->set_status_header(201);	
		echo json_encode(
            [
                'status' => 'ok',
    ...
    public function api_delete()
    {
		...
		if ($this->Urusanpemerintahan_Model->destroy($id)) {
		$this->output->set_status_header(201);
		echo json_encode(
            [
                'status' => 'ok',
