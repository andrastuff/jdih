...
class Lokasi extends Backend_Controller
{
    ...
    {
        $data['title'] = 'Lokasi';
        $data['content'] = 'lokasi/html/index';
        $data['footer'] = array(
    ...
    public function api_list()
    {
		...
		$result 	= $this->Lokasi_Model->get_all($limit, $offset, $search, $columns, $sort);
		$total		= $this->Lokasi_Model->count_all($search);
    ...
    public function api_update()
	{
		...
		if ($this->Lokasi_Model->update((int)$this->input->post('id', TRUE), $data)) { 	
    ...
    public function api_save()
	{
		...
		if ($this->Lokasi_Model->save($data)) { 	
		$this->output->set_status_header(201);	
		echo json_encode(
            [
                'status' => 'ok',
    ...
    public function api_delete()
    {
		...
		if ($this->Lokasi_Model->destroy($id)) {
		$this->output->set_status_header(201);
		echo json_encode(
            [
                'status' => 'ok',
