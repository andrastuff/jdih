            ...
            <div class="ibox shadow">
                ...
                <div class="ibox-content">
                    <div class="col-lg-12 pb-4 border-bottom">
                        <a href="<?php echo site_url('perundangan/add') ?>" class="btn btn-outline btn-primary"><i class="fa fa-plus"></i> <span class="nav-label">Tambah Perundangan</span></a>
                    </div>
