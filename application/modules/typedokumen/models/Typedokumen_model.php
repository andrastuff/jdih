...
class Typedokumen_model extends CI_Model
{
	public $primary		= 'id';
    public $search		= 'name';
    public $tbl_name	= 'type_dokumen';
	...
	// ===================================================================================================
    /** GET ALL WHERE : Menampilkan data di dalam filter */
    // ===================================================================================================
	...
	// ===================================================================================================
    /** GET ALL TURUNAN WHERE : Menampilkan data di dalam filter */
    // ===================================================================================================
    public function get_all_turunan_where($where)
    {
        if($where != null){
			$this->db->where('SUBSTRING(second_id, 1, 1) =', $where['second_id']);
		}
        $result = $this->db->get($this->tbl_name);
